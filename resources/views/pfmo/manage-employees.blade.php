                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-xl-4 mb-4">
                            <div class="card sub-dept-card h-100" data-sub-dept-id="{{ $subDept['id'] }}">
                                <div class="card-body">
                                    <h5 class="card-title text-primary">
                                        <i class="fas fa-building me-2"></i>
                                        {{ $subDept['name'] }}
                                    </h5>
                                    <p class="card-text text-muted small">{{ $subDept['description'] }}</p>
                                    
                                    <div class="mb-3">
                                        <strong>Current Supervisor:</strong>
                                        <div class="supervisor-info mt-1">
                                            @if($subDept['supervisor'])
                                                <span class="badge badge-supervisor text-white">
                                                    <i class="fas fa-crown me-1"></i>
                                                    {{ $subDept['supervisor']['name'] }}
                                                </span>
                                            @else
                                    ...
                                    <div class="mb-3">
                                        <small class="text-muted">
                                            ...
                                            {{ $subDept['employee_count'] }} employees assigned
                                        </small>
                                    </div>

                                    <div class="d-grid gap-2">
                                        <button type="button" class="btn btn-sm btn-primary action-btn" 
                                                onclick="showSupervisorModal({{ $subDept['id'] }}, '{{ $subDept['name'] }}', {{ $subDept['supervisor'] ? $subDept['supervisor']['id'] : 'null' }}, {{ $subDept['supervisor'] ? "'" . $subDept['supervisor']['name'] . "'" : 'null' }})">
                                            <i class="fas fa-user-tie me-1"></i>
                                            {{ $subDept['supervisor'] ? 'Change Supervisor' : 'Assign Supervisor' }}
                                        </button>
...
document.addEventListener('DOMContentLoaded', function() {
    // Initialize modals
    assignEmployeeModal = new bootstrap.Modal(document.getElementById('assignEmployeeModal'));

...
CREATE TABLE `job_orders` (
  ...
  `requestor_service_types` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL CHECK (json_valid(`requestor_service_types`)),
  ...
  `requestor_signature_style` varchar(255) DEFAULT NULL,
  `requestor_signature_date` date DEFAULT NULL,
  `status` enum('Pending','In Progress','Completed','Job Order Submitted','For Further Action') NOT NULL DEFAULT 'Pending',
  `requestor_feedback_required` tinyint(1) NOT NULL DEFAULT 1,
  `requestor_feedback_submitted` tinyint(1) NOT NULL DEFAULT 0,
  `requestor_satisfaction_rating` tinyint(3) unsigned DEFAULT NULL,
  `requestor_feedback_date` timestamp NULL DEFAULT NULL,
  ...
  CONSTRAINT `job_orders_created_by_foreign` FOREIGN KEY (`created_by`) REFERENCES `tb_account` (`accnt_id`) ON DELETE SET NULL,
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (30,'2025_08_22_131613_add_created_by_to_job_orders_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (31,'2025_08_22_163327_add_requestor_feedback_to_job_orders_table',6);
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES (32,'2025_08_25_145825_add_job_order_form_fields_to_job_orders_table',7);
